...
%analysis phi
PA1 = [0 1 0 0];
PA2 = [b(4)/k1 -1*((b(1)+b(2))*a(4)/a(1)+b(3))/k1 0 0];
PA3 = [0 0 0 0];
PA4 = [0 0 0 0];
PB2 = (-b(5)-(b(1)+b(2))*a(5)/a(1))/k1;
PB4 = 0;

%analysis theta
TA1 = [0 0 0 0];
TA2 = [b(4)/k1 -1*((b(1)+b(2))*a(4)/a(1)+b(3))/k1 0 0];
TA3 = [0 0 0 1];
TA4 = [-1*(2*a(1)+1)*b(4)/k2 ((2*a(1)+1)*b(3)+a(4))/k2 0 -1*((2*a(1)+1)*b(3)+a(3))/k2];
TB2 = 0;
TB4 = (a(5)+(2*a(1)+1)*b(5))/k2;
